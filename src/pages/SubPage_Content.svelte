<script lang="ts">
    ...
    import { post_comment, post_comment_child, delete_comment, modify_comment, delete_content, modify_file, delete_file, type IAuthor, type IComment, type IFile, type IPost } from "query";
    ...
    async function handleFileChange(event) {
        ...
        modify_file(params.content_id, files).then(b => {
        ...
        <div class="container_left">
            ...
            <div class="board_files">
                ...
                <button class="box_file" on:click={() => {downloadFile(file.file, "test.cpp");}}>
                    ...
                    <button class="btn_delete_file" on:click|stopPropagation={(event) => {
                ...
                {/each}
                <button class="box_file center" on:click={async () => {uploadFiles();}}>
                    <h1>+</h1>
                </button>
            </div>
        </div>
