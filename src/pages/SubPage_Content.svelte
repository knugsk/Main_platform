  ...
  {#if data !== null && data !== undefined && data.comments !== null && data.comments !== undefined}
    ...
    <div class="board_comment">
      ...
      <div class="box_send_comment">
        ...
        <button
          class="btn_send_comment"
          on:click={async () => {
            if (is_modify) {
              await modify_comment(
                modify_id,
                params.content_id,
                comment_text
              ).then((b) => {
